...
def get_namespace(name: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cosmo:index/getNamespace:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
...
def get_namespace_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cosmo:index/getNamespace:getNamespace', __args__, opts=opts, typ=GetNamespaceResult)
